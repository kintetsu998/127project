        ...
        <div id="modal1" className="modal">
          <form id="create-job" onSubmit={this.createJob}>
            <div className="modal-content">
              ...
              <textarea id="job-description" className="materialize-textarea" placeholder="Job description"></textarea>
              <input id="job-company" type="text" placeholder="Job company"/>
              <input id="job-field" type="text" placeholder="Job field"/>
            ...
            <div className="modal-footer">
              <button className="waves-effect waves-green btn-flat" type="submit">POST</button>
            </div>
          </form>
        </div>
      </div>
